...
// 2026-06-04 scout wave (CA)
import {
  apegnbNbEngineersEnabled,
  runApegnbNbEngineers,
} from "./sources/apegnb-nb-engineers.js";
...
async function main(): Promise<void> {
  ...
  // 2026-06-04 scout wave (CA)
  const apegnbNbEngineersOn = apegnbNbEngineersEnabled();
