...
import { delawareContractorSource, runDelawareContractor } from "./sources/delaware-contractor.js";
import {
  cgnNotariadoEnabled,
  runCgnNotariado,
...
async function main(): Promise<void> {
  ...
  const delawareContractorOn = delawareContractorSource.enabled();
  ...
  for (const [flag, name, runFn] of [
    ...
    [delawareContractorOn, "delaware-contractor", runDelawareContractor],
